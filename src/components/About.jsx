    ...
    <section id="about" className="bg-gray-800 py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <div className="w-24 h-1 bg-gradient-to-r from-gray-500 to-purple-600 mx-auto"></div>
        </div>

        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
            <div className="relative">
              <div className="w-80 h-80 mx-auto bg-gradient-to-br from-gray-500 to-purple-600 rounded-full flex items-center justify-center">
          ...
          <div className={`transition-all duration-1000 delay-300 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'}`}>
            ...
            <p className="text-gray-300 text-lg mb-6 leading-relaxed">
              I'm a passionate front-end web developer with over 4 years of experience creating
